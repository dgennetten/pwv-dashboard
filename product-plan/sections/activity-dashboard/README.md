...
- Scan KPIs, charts, and sortable trail coverage; optional drill via `onTrailSelect`
...
| `TrailCoverageList.tsx` | Sortable coverage table |
...
| `onTrailSelect` | User activates a trail row |
